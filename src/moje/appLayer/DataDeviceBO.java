...
public class DataDeviceBO {
    ...
    private static EntityManagerFactory emf = javax.persistence.Persistence.
            createEntityManagerFactory("a33PU");

    public static Datadevice createDadtaDeviceAndOutputs(String name,
            String building, String note, int outputCount) {
    ...
    public static void deleteDataDeviceAndOutpust(int id) {
        ...
        try {
            ...
            Logger.getLogger(DataDeviceBO.class.getName()).log(Level.SEVERE,
                    null, ex);
        }
    }

    public static Datadevice editdataDevice(int id, String name, String building,
            String note) {
        DatadeviceJpaController cont = new DatadeviceJpaController(emf);
