...
CREATE TABLE HWPOSITION (ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, NAME VARCHAR(10), NOTE VARCHAR(100), PHONENUMBER INTEGER, TECHNOLOGYTYPE CHAR(1), TELEXCHANGEOUTPUT INTEGER, TELECHANGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE PBXOUTPUT (ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, NOTE VARCHAR(100), PBXOUT INTEGER, PHONENUMBER INTEGER, TECHNOLOGYTYPE CHAR(1), PBX_ID INTEGER, PRIMARY KEY (ID))
